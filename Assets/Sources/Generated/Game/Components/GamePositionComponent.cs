...
public partial class GameEntity {
    ...
    public void AddPosition(UnityEngine.Vector2 newPositionVector) {
        var index = GameComponentsLookup.Position;
        var component = CreateComponent<PositionComponent>(index);
        component.PositionVector = newPositionVector;
        AddComponent(index, component);
    }

    public void ReplacePosition(UnityEngine.Vector2 newPositionVector) {
        var index = GameComponentsLookup.Position;
        var component = CreateComponent<PositionComponent>(index);
        component.PositionVector = newPositionVector;
